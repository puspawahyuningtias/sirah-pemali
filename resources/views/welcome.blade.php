	...
	<div class="d-flex flex-column flex-root">
							...
							<div class="d-lg-block" id="kt_header_nav_wrapper">
								<div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true" data-kt-drawer-name="landing-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="200px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_landing_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav_wrapper'}">
									...
									<div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-500 menu-state-title-primary nav nav-flush fs-5 fw-bold" id="kt_landing_menu">
										...
										<div class="menu-item">
											<!--begin::Menu link-->
											<a class="menu-link active nav-link py-3 px-4 px-xxl-6" href="/">Home</a>
											<!--end::Menu link-->
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
		...
		<div class="mb-n10 mb-lg-n20">
			...
			<div class="container">
				...
				<!--end::Heading-->
				<!--begin::Row-->
				<div class="row w-100 gy-10 mb-md-20 pb-15 align-items-center">
					<!--begin::Col-->
		...
		<!--begin::How It Works Section-->
		<div class="mb-n10 mb-lg-n20" style="background-color: #EEF6F5;">
			<!--begin::Container-->
			<div class="container">
				<!--begin::Heading-->
				<div class="text-start my-17">
					<!--begin::Title-->
					<h3 class="text-dark mb-5" id="how-it-works" data-kt-scroll-offset="{default: 100, lg: 150}">Ada apa aja si di Wanawisata</h3>
					<h3 class="fs-2hx text-dark mb-5" id="how-it-works" data-kt-scroll-offset="{default: 100, lg: 150}">Sirah Pemali</h3>
					<!--end::Title-->
				</div>
				<!--end::Heading-->
				<!--begin::Row-->
				...
				<div class="text-center my-5">
					<!--begin::Title-->
					<h3 class="fs-2hx text-dark mb-5" id="how-it-works" data-kt-scroll-offset="{default: 100, lg: 150}">Mengapa harus<br>Sirah Pemali ?</h3>
					<!--end::Title-->
					<!--begin::Text-->
					<div class="fs-5 text-muted fw-bold">Mengapa Kita harus berkunjung ke Wanawisata Sirah pemali
					</div>
					<!--end::Text-->
				</div>
				<!--end::Heading-->
				...
				<div class="container my-20">
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="text-start my-17">
								<!--begin::Title-->
								<h1 class="text-dark mb-5">Jam Opersional & Harga<br>Tiket Masuk Sirah Pemali</h1>
								<!--end::Title-->
								<!--begin::Sub-title-->
								<div class="fs-5 text-muted fw-bold">
									...
									<div class="my-3">
										...
										<span class="fs-4 mb-6">Senin - Jumat : Rp 10.000</span>
									</div>
									<div class="my-3">
										<i class="bi bi-check-circle-fill text-success fs-4"></i>
		...
		<div class="mt-20 mb-n20 pt-20 landing-dark-bg">
			<!--begin::Container-->
			<div class="container">
				<!--begin::Heading-->
				<div class="text-center mb-17">
					<!--begin::Title-->
					<h3 class="fs-2hx text-white mb-5" id="clients" data-kt-scroll-offset="{default: 125, lg: 150}">Apa Kata Mereka tentang Sirah Pemali</h3>
					<!--end::Title-->
					<!--begin::Description-->
					<div class="fs-5 text-white fw-bold">Share your experiences and give us constructive criticism and input<br>input for us is so valuable for our progress going forward
					</div>
					<!--end::Description-->
				</div>
				<!--end::Heading-->
					...
					<div class="col-md-3 bg-white rounded py-10 px-5 mb-10">
						...
						<div class="d-flex flex-column justify-content-between h-lg-50 px-10 px-lg-0 pe-lg-10 mb-15 mb-lg-0">
							...
							<div class="mb-7">
								...
								<!--end::Rating-->
								<!--begin::Feedback-->
								<div class="text-gray-500 fs-7">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tortor, faucibus dolor massa feugiat iaculis. </div>
								<!--end::Feedback-->
							</div>
							<!--end::Wrapper-->
							<!--begin::Author-->
